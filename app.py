...
def index():
    if request.method == 'POST':
                ...
                #     client = pymongo.MongoClient("mongodb+srv://Abhyudaya:Abhyudaya@cluster0.lkjxcm4.mongodb.net/?retryWrites=true&w=majority")
                #     db = client.test
                #     db = client['image_scrap']
                    
                    
                    client = pymongo.MongoClient("mongodb+srv://abhyudayadubey2002:devdubey@cluster0.qma1dc8.mongodb.net/?retryWrites=true&w=majority")
